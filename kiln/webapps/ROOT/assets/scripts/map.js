  ...
  require(['app/main', 'jquery', 'leaflet', 'leaflet-groupedlayercontrol'],
    function(main, $, leaflet, lglc) {
      ...
      function drawPoint(a) {
        for (i in a.features) {
          ancientMarker[i] = new L.marker([a.features[i].features[0]['geometry'].coordinates[1], a.features[i].features[0]['geometry'].coordinates[0]],{icon: marker});
      ...
      var marker = new LeafIcon({iconUrl: '../assets/images/map-marker.png'});
