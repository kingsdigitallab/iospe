        ...
        <div class="row">
            <div class="large-12 columns">
                <div class="section-auto-sample-accordion" data-section="accordion">
                    <section>
                        <p class="title-sample" data-section-title="">
                            <a href="#section1">See table of contents for Introduction ...</a>
                        </p>
                            ...
                            <p>
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <ul>
                                            <li>
                                                <a href="introduction.html#I-1-">Structure of the
                                                  volume</a>
                                                <ul>
                                                  <li>
                                                  ...
                                                  <li>
                                                  <a href="introduction.html#I-1-B-"
                                                  >Inscriptions</a>
                                                  <ul>
                                                  <li>
                                            ...
                                            <li>
                                                <a href="introduction.html#I-2-">Criteria of
                                                  selection</a>
                                                <ul>
                                                  <li>
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            <li>
                                                <a href="introduction.html#II-1-">End of the XVIIIth
                                                  – first half of the XIXth century – an era of
                                                  travellers and antiquarians</a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <a href="introduction.html#II-3-">Late XIXth - Early
                                                  XXth century – an era of systematic searches and
                                                  publications</a>
                                            </li>
                                            <li>
                                                <a href="introduction.html#II-4-">Soviet period – an
                                                  era of unsystematic studies</a>
                                            </li>
                                            <li>
                                                <a href="introduction.html#II-5-">1980-2000 –
                                                  revival of interest</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a href="introduction.html#III-">Geography and
                                            Chronology</a>
                                    </li>
                                    <li>
                                        <a href="introduction.html#IV-">Classification of
                                            Inscriptions</a>
                                        <ul>
                                            <li>
                                            ...
                                            <li>
                                                ...
                                                <ul>
                                                  <li>
                                                  <a href="introduction.html#IV-2-A-">Early
                                                  Byzantine Palaeography</a>
                                                  <ul>
                                                  <li>
                                                  ...
                                                  <li>
                                                  <a href="introduction.html#IV-2-B-">Middle
                                                  Byzantine Palaeography</a>
                                                  </li>
                                                  <li>
                                            ...
                                            <li>
                                                <a href="introduction.html#IV-3-">Types of
                                                  Inscriptions and Epigraphic Formulae</a>
                                                <ul>
                                                  <li>
                                                  ...
                                                  <li>
                                                  <a href="introduction.html#IV-3-E-"
                                                  >Invocations</a>
                                                  <ul>
                                                  <li>
                                            ...
                                            <li>
                                                <a href="introduction.html#IV-4-">Epigraphic dating
                                                  and eras</a>
                                                <ul>
                                                  <li>
                                            ...
                                            <li>
                                                ...
                                                <ul>
                                                  <li>
                                                  <a href="introduction.html#IV-5-A-">Orthography
                                                  and Phonetics</a>
                                                  </li>
                                                  <li>
